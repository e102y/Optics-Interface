        ...
        public static List<physRay> Traverse(state q1, bool NeuralNet)
        {
            ...
            while (q1.rays.Count > 0)
            {
                if (!NeuralNet)
                {
                    ...
                    if (rcurrent.level < q1.planes.Count && rcurrent.level >= 0)
                    {
                    ...
                    if ((!rcurrent.direction && rcurrent.level - 1 >= 0) || (rcurrent.direction && rcurrent.level + 1 < q1.planes.Count))
                    ...
                    */
                    ...
                    if (nextMagnitude > magThreshold && ((rcurrent.direction && nextLevel < q1.planes.Count + 1) || (!rcurrent.direction && nextLevel >= 0 - 1)))
                    {
                        rnext = new physRay
                        {
                    ...
                    if (nextMagnitude > magThreshold && ((rcurrent.direction && nextLevel < q1.planes.Count - 1) || (!rcurrent.direction && nextLevel > 0)))
                    {
                        rnext = new physRay
                        {
                            x = rcurrent.x + q1.planeHeights[rcurrent.level] * Math.Tan(rcurrent.theta),
